var rule = {
    title: '闪雷电',
    编码: 'gb2312',
    host: 'http://114.103.30.116:18008',
    url: '/www/List.asp?classid=fyclass&searchword=&page=fypage',
    filterable: 0,//是否启用分类筛选,
    class_name: '电影&电视剧&综艺&动漫&音乐MTV',
    ...
    play_parse: true,
    lazy: $js.toString(() => {
        var html = 'http://114.103.30.116:18008/PlayMov.asp?ClassId=' + input.split(",")[2] + '&video=2&exe=0&down=0&movNo=' + input.split(",")[3] + '&vgver=undefined&ClientIP=114.103.30.116'
